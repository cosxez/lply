...
void glssa(SDL_Renderer *ren,unsigned int win_width,unsigned int win_height,unsigned short delay,unsigned char k,int r_ofst,int g_ofst,int b_ofst,unsigned char *_binary_cvnt_whld_start)
{
	unsigned char kk=0;
	while (kk<k)
	{
